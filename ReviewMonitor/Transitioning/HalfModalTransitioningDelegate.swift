...
class HalfModalTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
    ...
    init(viewController: UIViewController, presentingViewController: UIViewController) {
        ...
        interactionController = HalfModalInteractiveTransition(viewController: self.viewController, withView: self.presentingViewController.view, presentingViewController: self.presentingViewController)
